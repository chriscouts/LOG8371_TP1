/*
 *    CustomRandomHoeffdingTree.java
...
/**
 * Random decision trees for data streams with improved array uniqueness check.
 *
 * @author Équipe Papa - INF8371 based on Albert Bifet (abifet at cs dot waikato dot ac dot nz)
 */
public class CustomRandomHoeffdingTree extends HoeffdingTree {
    ...
    public static class CustomRandomLearningNode extends ActiveLearningNode {
        ...
        public CustomRandomLearningNode(double[] initialClassObservations) {
            ...
            if (this.listAttributes == null) {
                ...
                for (int j = 0; j < this.numAttributes; j++) {
                    ...
                    while (isUnique == false) {
                        ...
                        isUnique = true;
                        if(!set.add(this.listAttributes[j])) {
                            isUnique = false;
                        }
                    }
    ...
    public static class LearningNodeNB extends CustomRandomLearningNode {
    ...
    public CustomRandomHoeffdingTree() {
    ...
    protected LearningNode newLearningNode(double[] initialClassObservations) {
        ...
        if (predictionOption == 0) { //MC
            ret = new CustomRandomLearningNode(initialClassObservations);
